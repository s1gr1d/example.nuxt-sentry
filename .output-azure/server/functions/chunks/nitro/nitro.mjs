;{try{let e="undefined"!="undefined"?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="f762e937-ee4a-4b8d-8d08-9a57ee5929b6",e._sentryDebugIdIdentifier="sentry-dbid-f762e937-ee4a-4b8d-8d08-9a57ee5929b6")}catch(e){}};import { unified } from 'unified';
...
import { dropUndefinedKeys, getTraceMetaTags, GLOBAL_OBJ, vercelWaitUntil, logger, flush, getIsolationScope, getDefaultIsolationScope, withIsolationScope } from '@sentry/core';
...
const _KAAnqBdWdo = defineNitroPlugin((nitroApp) => {
...
const _puDAZx2ajA = defineNitroPlugin((nitro) => {
...
const _R7mpOk = defineEventHandler((event) => {
  console.log("New request: " + getRequestURL(event));
});

const _fLvCRF = defineEventHandler((event) => {
  console.log("New request: " + getRequestURL(event));
});
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "fefa208a-ebf1-4fe7-ad0c-7714920f5a75",
...
const _assets = {
  ["nitro:bundled:cache:content:content-index.json"]: {
    ...
    meta: {"type":"application/json","etag":"\"25-965WJNTVmvch1fn+1L+GMuLEpy4\"","mtime":"2025-02-19T11:58:49.515Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('../raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"2a-NZROuAJdxSzlF9HrYJLauHjDG1Q\"","mtime":"2025-02-19T11:58:49.515Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:document.md"]: {
    import: () => import('../raw/document.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"23a-Ok2lO/JW36xHqiELup+y39LwggQ\"","mtime":"2025-02-19T11:58:49.516Z"}
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/sigridh/Documents/DEV/test-applications/example.nuxt-sentry/.data/kv"}));
...
const _1V2q8p = defineEventHandler(async (event) => {
...
const _lM1H8x = defineEventHandler(async (event) => {
...
const _fxus0y = defineEventHandler(async (event) => {
  const { getContentQuery } = await import('../_/query.mjs');
  const { cacheStorage, serverQueryContent } = await import('../_/storage.mjs').then(function (n) { return n.s; });
...
const _lazy_Op5Pkj = () => import('../routes/api/redis.mjs');
const _lazy_LW4DbN = () => import('../routes/api/sentry-example-api.mjs');
const _lazy_vCiiHg = () => import('../routes/api/server-error.mjs');
const _lazy_xfY8Bu = () => import('../routes/api/test-param/_param_.mjs');
const _lazy_p2zBO2 = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '', handler: _R7mpOk, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _fLvCRF, lazy: false, middleware: true, method: undefined },
  { route: '/api/redis', handler: _lazy_Op5Pkj, lazy: true, middleware: false, method: undefined },
  { route: '/api/sentry-example-api', handler: _lazy_LW4DbN, lazy: true, middleware: false, method: undefined },
  { route: '/api/server-error', handler: _lazy_vCiiHg, lazy: true, middleware: false, method: undefined },
  { route: '/api/test-param/:param', handler: _lazy_xfY8Bu, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_p2zBO2, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _1V2q8p, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _1V2q8p, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _1V2q8p, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.1739966312226.json', handler: _lM1H8x, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _fxus0y, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _fxus0y, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _fxus0y, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_p2zBO2, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, baseURL as A, parseQuery as B, getContext as C, createHooks as D, hasProtocol as E, isScriptProtocol as F, withQuery as G, sanitizeStatusCode as H, createDebugger as I, withTrailingSlash as J, toRouteMatcher as K, createRouter$1 as L, withBase as M, kebabCase as N, klona as O, parse as P, getRequestHeader as Q, isEqual as R, setCookie as S, getCookie as T, deleteCookie as U, createStorage as V, memoryDriver as W, handle as X, defineRenderHandler as a, buildAssetsURL as b, getQuery as c, defineEventHandler as d, createError$1 as e, getRouteRules as f, getRouterParam as g, getResponseStatus as h, getResponseStatusText as i, useNitroApp as j, parseMarkdown as k, isRelative as l, destr as m, camelCase as n, joinURL as o, publicAssetsURL as p, isPreview as q, prefixStorage as r, useStorage as s, withoutTrailingSlash as t, useRuntimeConfig as u, getPreview as v, withLeadingSlash as w, hash as x, defu as y, pascalCase as z };
